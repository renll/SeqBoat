...
class SeqBoatSentenceEncoderLayer(nn.Module):
    """
    ...
    def __init__(
        ...
        self.mega_layer = self.build_mega_layer(embedding_dim, hidden_dim, z_dim, n_dim,
                                           ...
                                           norm_type, prenorm, feature_dropout, export, max_steps,init_temp_scale,local_pos,always_act)
    ...
    def forward(
        ...
        x, attn, loss = self.mega_layer(x, x_padding_mask, act_bias = act_bias,layer_idx = layer_idx)
