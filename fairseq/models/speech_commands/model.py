...
from fairseq.models.speech_commands.seqboat_scraw_encoder import SeqBoatSCRawEncoder
...
class SCRawModel(FairseqEncoderModel):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--layer-type', choices=['mega', 'slag'])
...
class SCRawEncoder(FairseqEncoder):
    ...
    def __init__(self, args, task):
        ...
        if args.layer_type == 'mega':
            ...
            self.encoder = SeqBoatSCRawEncoder(
                num_encoder_layers=args.encoder_layers,
                embedding_dim=args.encoder_embed_dim,
                hidden_dim=args.encoder_hidden_dim,
                ffn_hidden_dim=args.encoder_ffn_embed_dim,
...
@register_model_architecture('sc_raw', 'slag_sc_raw_base')
def slag_lra_sc_base(args):
